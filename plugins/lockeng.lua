...
local msgs = 
{
    ...
    Locked = "تم قفل اللغة الاكليزية", -- the message that send when you lock the english

    already_unlocked = "تم بلفعل ايقاف منع اللغة الانكليزية", -- the message that sent when you try to unlock the english and it's already unlocked
    UnLocked = "تم ايقاف منع الانكليزية", -- the message that send when you unlock the english
